...
def get_public_data(input_data_path):
    ...
    data12 = pd.read_csv(os.path.join(input_data_path, "2018-seattle-business-districts.csv"))
    ...
    data16 = pd.read_csv(os.path.join(input_data_path, "Book1.xlsx-credit-card-number.csv"))
    ...
    data31 = pd.read_csv(os.path.join(input_data_path, "Book1.xlsx-us-social-security-22-cvs.csv"))
